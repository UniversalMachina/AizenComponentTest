...
const NavLink = ({ Icon, text, path, onSignOut }) => {
  ...
  return (
    <li className="list-none">
      <Link
        to={`/${path}`}
        className="flex items-center text-customGray-1800 py-[5px] pl-8 pr-6 h-12 overflow-hidden text-ellipsis whitespace-nowrap transition-all duration-300 ease-in-out font-light hover:bg-customGray-200 relative no-underline"
