...
const HeaderComponent1 = () => {
  const contentData = {
    introText: "A seamless experience with TestApp",
    mainTitle: "Accelerate Your Business with Innovative Solutions",
    description: "An intuitive and responsive application is key to customer retention. Optimize design and functionality for user satisfaction.",
  };
