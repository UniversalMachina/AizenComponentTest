...
const FrameComponent30 = () => {
  ...
  const contentData = {
    mainTitle: "Education",
    mainDescription: `TestApp transforms the way you interact with your customers, offering intelligent solutions that respond to your unique needs and enhance communication in groundbreaking ways.`,
    questions: [
      {
        question: "Question 1",
        answer:
          "How does TestApp help automate customer interactions effectively?",
      },
      {
        question: "Question 2",
        answer:
          "Can TestApp handle complex queries and return personalized responses?",
      },
      {
        question: "Question 3",
        answer:
          "Is TestApp easy to integrate with existing systems and workflows?",
      },
      {
        question: "Question 4",
        answer:
          "What kind of support and resources does TestApp offer to new users?",
      },
    ],
  };
