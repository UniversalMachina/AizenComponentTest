...
const Contact = () => {
  return (
    <section className="self-stretch bg-white overflow-hidden flex flex-col items-start justify-start pt-[149.3px] pb-[149.4px] pr-[610.2px] pl-[85.3px] box-border gap-[106.7px] max-w-full shrink-0 text-center text-[16px] text-black font-Roboto lg:gap-[53px_106.7px] lg:pl-[42px] lg:pr-[305px] lg:box-border mq450:pt-[63px] mq450:pb-[63px] mq450:box-border mq825:gap-[27px_106.7px] mq825:py-[97px] mq825:pr-[152px] mq825:pl-[21px] mq825:box-border">
