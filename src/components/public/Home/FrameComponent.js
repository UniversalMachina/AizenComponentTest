...
const FrameComponent = ({ className = "" }) => {
  ...
  const contentData = {
    subHeader: "YOUR DIGITAL EDGE",
    header: "OUR SOLUTIONS",
    frameComponents: [
      {
        header: "AUTOMATED RESPONSES",
        description:
          "Transform text inputs into instant messages, enhancing user engagement effortlessly.",
      },
      {
        header: "NAME TO SURNAME",
        description:
          "Efficiently generate last names from first names, streamlining your data process.",
      },
      {
        header: "PDF TO TEXT",
        description:
          "Easily convert PDFs to text, ensuring content is accessible and editable.",
      },
      {
        header: "PERSONALIZED INTERACTIONS",
        description:
          "Empower your communications with customized, prompt-based responses.",
      },
    ],
  };
