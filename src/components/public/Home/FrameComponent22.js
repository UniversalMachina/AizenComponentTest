...
const FrameComponent22 = () => {
  ...
  const contentData = {
    mainHeading: "Unlock the Power of Our Innovative SaaS Solution",
    benefits: [
      {
        heading: "Seamless Integration",
        description:
          "Easily connect with new prospects through our personalized tools.",
      },
      {
        heading: "Strengthen Relationships",
        description:
          "Foster stronger connections with tailored engagement features.",
      },
      {
        heading: "Advanced Techniques",
        description:
          "Boost your outreach using our state-of-the-art technology and insights.",
      },
    ],
  };
