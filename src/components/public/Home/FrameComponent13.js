...
const FrameComponent13 = ({ className = "" }) => {
  ...
  const contentData = {
    contentData1: {
      heading: "Lorum Ipsum",
      description:
        "Enhance interactions by tailoring messages uniquely for every new contact",
    },
    contentData2: {
      heading: "Dolor Sit Amet",
      description:
        "Easily engage your audience to foster meaningful relationships",
    },
    contentData3: {
      heading: "Consectetur Adipiscing",
      description:
        "Uncover and seize opportunities, expanding your network seamlessly",
    },
  };
