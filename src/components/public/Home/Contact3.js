...
const Contact3 = () => {
  ...
  return (
    <div className="self-stretch bg-white overflow-hidden flex flex-col items-start justify-start pt-[149.3px] pb-[149.4px] pr-[85px] pl-[85.3px] shrink-0 text-left text-black font-Roboto mq450:gap-[27px_106.7px] mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pt-[97px] mq750:pb-[97px] mq750:box-border mq1050:gap-[53px_106.7px] mq1050:pl-[42px] mq1050:pr-[42px] mq1050:box-border">
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col items-start justify-center gap-[29.9px] min-w-[535px] shrink-0">
        ...
        />
        <label className="w-[132.5px] h-[34.5px] flex flex-row items-start justify-start pt-[1.4px] px-0 pb-[16.3px] box-border relative gap-[7.5px] text-[13.1px]">
          <input
            className="m-0 h-[18.7px] w-[18.7px] relative box-border overflow-hidden shrink-0 border-[0.9px] border-solid border-black"
            type="checkbox"
            checked={acceptTerms}
            onChange={handleCheckboxChange}
          />
          <span className="absolute !m-[0] top-[-0.2px] right-[-90.8px] leading-[20px]">
        ...
        <button className="cursor-pointer py-[11.2px] px-[22.2px] bg-black box-border flex flex-row items-start justify-start border-[0.9px] border-solid border-black hover:bg-darkslategray-100 hover:box-border hover:border-[0.9px] hover:border-solid hover:border-darkslategray-100">
          <div className="relative text-[14.9px] leading-[150%] font-Roboto text-white text-left inline-block min-w-[48px]">
            Submit
          </div>
        </button>
