...
const FrameComponent26 = () => {
  ...
  const contentData = {
    heading: "Boost Your Efficiency with TestApp",
    description:
      "Streamline your workflow effortlessly with TestApp's advanced features. From transforming prompts into messages, names into last names, to converting PDFs into text, we make everyday tasks easier.",
  };
