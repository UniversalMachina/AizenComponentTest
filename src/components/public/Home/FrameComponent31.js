...
const FrameComponent31 = () => {
  ...
  const contentData = {
    ...
    testimonials: [
      {
        header: "Trusted Feedback",
        subHeader: "From Our Users",
        description:
          "Experience seamless communication with our innovative solutions. Transform how you reach and engage with your clients effortlessly. Let our tools drive your success with personalized interactions.",
      },
      {
        header: "Client Approval",
        subHeader: "User Experiences",
        description:
          "Leverage our technology for effective engagement. Simplify interactions and gain positive responses from your audience. Improve your outreach with our cutting-edge features.",
      },
      {
        header: "User Satisfaction",
        subHeader: "Happy Clients",
        description:
          "Elevate your communication with our state-of-the-art applications. Our solutions ensure you connect effectively with your prospects. Discover the power of personalized engagement with us.",
      },
      {
        header: "Customer Reviews",
        subHeader: "Feedback & Praise",
        description:
          "Maximize your outreach potential using our application. Engage with your audience brilliantly. Let us help you build strong, meaningful connections with our tailored services.",
      },
    ],
};
