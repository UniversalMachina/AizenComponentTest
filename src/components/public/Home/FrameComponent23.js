...
const FrameComponent23 = () => {
  ...
  const contentData = {
    mainHeading: "TestApp",
    mainDescription1: `Revolutionize the way you connect with clients using our advanced SaaS solutions. Revolutionize the way you connect with clients using our advanced SaaS solutions. Revolutionize the way you connect with clients using our advanced SaaS solutions. Revolutionize the way you connect with clients using our advanced SaaS solutions.`,
    mainDescription2: `Revolutionize the way you connect with clients using our advanced SaaS solutions. Revolutionize the way you connect with clients using our advanced SaaS solutions.`,
    statistics: [
      {
        value: "32+",
        description: "Innovations in client engagement",
      },
      {
        value: "32+",
        description: "Innovations in client engagement",
